...
import com.sinosoft.response.ResponseResult;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.sinosoft.common.IStatusMessage;
...
import com.sinosoft.util.ShiroFilterUtils;
...
public class KickoutSessionFilter extends AccessControlFilter {
    ...
    public static void out(ServletResponse response, ResponseResult result){
        ...
        try {
            ...
            response.setContentType("ybt-config/applicationContext/json");//设置返回类型
